...
async function install() {
  try {
    ...
    // Format: https://github.com/KeithWyatt/gongshow/releases/download/v0.1.0/gongshow_0.1.0_darwin_amd64.tar.gz
    const releaseVersion = VERSION;
    const archiveExt = platformName === 'windows' ? 'zip' : 'tar.gz';
    const archiveName = `gongshow_${releaseVersion}_${platformName}_${archName}.${archiveExt}`;
    const downloadUrl = `https://github.com/KeithWyatt/gongshow/releases/download/v${releaseVersion}/${archiveName}`;
    ...
    console.error('1. Installing manually from: https://github.com/KeithWyatt/gongshow/releases');
    console.error('2. Opening an issue: https://github.com/KeithWyatt/gongshow/issues');
    process.exit(1);
  }
}
