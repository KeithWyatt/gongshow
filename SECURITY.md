...
If you discover a security vulnerability in GongShow, please report it responsibly:
...
GongShow is experimental software focused on multi-agent coordination. Security considerations include:
